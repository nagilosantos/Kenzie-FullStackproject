...
- dashboard do cliente - onde o cliente tem acesso aos seus contatos, podendo criar, editar ou deletá-los. Há também um botão, escrito editar perfil, que redireciona usuário, para o modal de edição de perfil;

<h2 font-family="pattaya">Requisitos técnicos:</h2><br>

- a aplicação utiliza api rodando localmente na máquina do usuário. É preciso clonar este <a href="https://github.com/nagilosantos/Kenzie-FullStackproject/tree/main/back-end" font-family="robotto" font-size="16px">repositório</a>, para visualizar suas funcionalidades;
